...
contract Ownable {
    ...
    function _transferOwnership(address _newOwner) internal{
        require(_newOwner != address(0),"require new address to transfer");
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(owner != to,"Sender is already a owner of token");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner || isApprovedForAll(owner,msg.sender),"Sender is not owner of contract");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        // TODO revert if given tokenId already exists or given address is invalid
            require(to != address(0)||!_exists(tokenId),"address is invalid or tokenId already exists");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == owner,"caller is not the owner of token Id");
...
contract ERC721Mintable is ERC721Metadata{
    string private _name ="Kursor";
    string private _symbol = "Kur";
